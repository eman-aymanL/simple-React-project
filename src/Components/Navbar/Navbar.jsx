        ...
        <div className="hidden w-full md:block md:w-auto" id="navbar-multi-level">
          <ul className="md:h-12 rounded-lg text-center flex flex-col font-medium p-4 md:p-0 mt-4 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 bg-onPrimary dark:bg-emerald-700 dark:text-white">
           ...
           <label className="inline-flex items-center cursor-pointer">
              <input type="checkbox" value="" checked={isDarkMode} onChange={toggleTheme} className="sr-only peer" />
            ...
            <button onClick={toggleLanguage}  className="m-2 px-3 py-1 text-sm font-semibold text-gray-800 dark:text-white rounded-md hover:bg-gray-200 dark:hover:bg-emerald-700 transition">
              {isArabic ? 'EN' : 'AR'}
            </button>
           </li>
          </ul>
